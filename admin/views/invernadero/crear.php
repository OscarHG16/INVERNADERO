...
<form method="post" action="invernadero.php?accion=<?php if($accion == "crear"):echo('nuevo');else:
    echo('modificar&id='.$id);endif; ?>">
    <div class="mb-3">
        <label for="invernadero" class="form-label">Nombre del invernadero</label>
        <input class="form-control" type="text" name="data[invernadero]" placeholder="Escribe aqui el nombre" 
        id="invernadero" value="<?php
    ...
    <div class="mb-3">
        ...
        <input class="form-control" type="text" name="data[latitud]" placeholder="Escribe aqui la Latitud" 
        id="latitud" value="<?php
    ...
    <div class="mb-3">
        ...
        <input class="form-control" type="text" name="data[longitud]" placeholder="Escribe aqui la Longitud" 
        id="longitud" value="<?php
